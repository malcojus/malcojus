...
**Cloud:** Azure (networking, IAM/Entra ID, governance, Databricks) — primary focus. Familiar with AWS, GCP and DigitalOcean.
**IaC:** Terraform/OpenTofu
**CI/CD:** Azure DevOps, Bitbucket Pipelines, GitHub Actions, Jenkins.
**Languages:** Go, Python, Bash, PowerShell.
**Identity:** Entra ID, Auth0.
**Also:** Docker, observability (OTel, Grafana, Prometheus), self-hosted everything.

---

## How I think about it

AI made creation cheap and accountability expensive. I build the tooling and infrastructure that closes that gap — secure by default, reproducible, and owned by the people who run it. Data sovereignty is more important than ever in today's world.
